%% Step 4: IQ----Picture vocabulary: 26302
clear
clc
...
for s_sub = 1:size(ICA_fold_out_use,1)
    ...
    if strcmp(tmp_sess, 'ses_01')
        ...
        input_IQ(s_sub,1) = table2array(demo_ana1(s_sub,3264));

    elseif strcmp(tmp_sess, 'ses_02')
        input_age(s_sub,1) = table2array(demo_ana3(s_sub,5));
        input_IQ(s_sub,1) = table2array(demo_ana1(s_sub,3265));
...
save('Step4_FNC_vs_IQ6_QC4.mat', 'asso_FNC', 'use_idx')