%% Step 4: IQ----Matrix patterns: 6373/6374
clear
clc
...
for s_sub = 1:size(ICA_fold_out_use,1)
    ...
    if strcmp(tmp_sess, 'ses_01')
        ...
        input_IQ(s_sub,1) = table2array(demo_ana1(s_sub,1587))./table2array(demo_ana1(s_sub,1589));

    elseif strcmp(tmp_sess, 'ses_02')
        input_age(s_sub,1) = table2array(demo_ana3(s_sub,5));
        input_IQ(s_sub,1) = table2array(demo_ana1(s_sub,1588))./table2array(demo_ana1(s_sub,1590));
...
save('Step4_FNC_vs_IQ2_QC4.mat', 'asso_FNC', 'use_idx')