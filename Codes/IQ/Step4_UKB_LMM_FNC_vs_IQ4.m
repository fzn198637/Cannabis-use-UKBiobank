...
for s_sub = 1:size(ICA_fold_out_use,1)
    ...
    if strcmp(tmp_sess, 'ses_01')
        ...
        input_IQ(s_sub,1) = table2array(demo_ana1(s_sub,961));

    elseif strcmp(tmp_sess, 'ses_02')
        input_age(s_sub,1) = table2array(demo_ana3(s_sub,5));
        input_IQ(s_sub,1) = table2array(demo_ana1(s_sub,962));
...
save('Step4_FNC_vs_IQ4_QC4.mat', 'asso_FNC', 'use_idx')